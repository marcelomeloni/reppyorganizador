...
export default function ConfigPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    slug: 'valhalla',
    description: 'A maior e melhor república de Limeira. Desde 2012 fazendo história.',
    email: 'contato@valhalla.com',
    phone: '(19) 99876-5432',
    instagram: 'repvalhalla',
    website: 'www.valhalla.com.br',
    category: 'Republica',
  })
  ...
  const handleDeleteConfirm = () => {
    console.log('Deletando organização...')
  }
                ...
                <div className="absolute left-4 md:left-6 -bottom-9 md:-bottom-10">
                  <div className="relative group w-20 h-20 md:w-24 md:h-24 rounded-[16px] md:rounded-[20px] border-[4px] md:border-[5px] border-white bg-[#F0F0EB] shadow-xl overflow-hidden">
                    {profilePreview ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center text-[#9A9A8F] font-display font-extrabold text-2xl bg-[#F0F0EB]">
                  ...
                  {CATEGORIES.map(({ value, label, Icon }) => {
                    ...
                    return (
                      <button
                        ...
                        className={`
                          flex items-center gap-2.5 md:gap-3 px-3 md:px-4 py-2.5 md:py-3 rounded-xl border-2 transition-all text-sm font-semibold text-left
                          ${active
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
                ...
                <Field label="WhatsApp *" icon={<WhatsappLogo size={12} weight="fill" />}>
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, phone: handlePhoneMask(e.target.value) })
                    }
